              ...
              <div class="col-md-12">
                ...
                <ul class="row subcategories">
                  <li class="col-md-12" v-for="cat in Subcategory" :key="cat">
                    <a
                      class="nav-link signup"
                      :href="`/newItem/itemDetails/${offer}/${cat.id}`"
                    >
                      <div class="singleCat">
                        <font-awesome-icon :icon="cat.iconName" />
                        <span>{{ cat.title }}</span>
                      </div>
                      <div class="forIcon">
