...
<div class="username">
    <div class="edit">
    <h4>Julia Ann</h4>
    <a href="#" v-if="user" class="btn Edit">Edit</a>
    </div>

    <div class="row">
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12" v-for="index in 8" :key="index">
...
<script>
import SingleArchive from "../home/SingleArchive.vue"
